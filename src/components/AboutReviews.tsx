...
const AboutReviews = () => {
  return (
    <section className="flex flex-col items-center px-4 py-12 text-center font-lato">
      ...
      <div className="w-full max-w-sm bg-gradient-to-b from-[#08268F] to-[#00BFFF] rounded-[2rem] text-white shadow-lg">
        {/* Item 1 */}
        <div className="py-6 border-b border-white/20">
          <p className="text-4xl font-bold">
            <Counter end={8} suffix="+" duration={5} />
          </p>
        ...
        <div className="py-6 border-b border-white/20">
          <p className="text-4xl font-bold">
            <Counter end={50} suffix="+" duration={5.5} />
          </p>
        ...
        <div className="py-6 border-b border-white/20">
          <p className="text-4xl font-bold">
            <Counter end={100} suffix="+" duration={7} />
          </p>
        ...
        <div className="py-6 border-b border-white/20">
          <p className="text-4xl font-bold">
            <Counter end={20} suffix="+" duration={5.5} />
          </p>
        ...
        <div className="py-6">
          <p className="text-4xl font-bold">
            <Counter end={500} suffix="%" duration={5} />
          </p>
