      ...
      <div className="flex flex-col lg:flex-row sm:gap-8">
        ...
        <div className="grid grid-cols-2 gap-y-4 text-center sm:flex sm:justify-between lg:gap-x-32 sm:text-left lg:ml-auto lg:w-auto">
          <div className="space-y-1 text-left">
            ...
            <p className="hover:text-[#08268F]">
              <Link to="/linebridge/home">Help Center</Link>
            </p>
            <p className="hover:text-[#08268F]">
              <Link to="/linebridge/home">Privacy Policy</Link>
            </p>
          </div>
          <div className="space-y-1 text-right">
            <p className="hover:text-[#08268F]">
              <Link to="/linebridge/careers">Careers</Link>
            </p>
            <p className="hover:text-[#08268F]">
              <Link to="/linebridge/contacts">Contact Us</Link>
            </p>
            <p className="hover:text-[#08268F]">
              <Link to="/linebridge/home">Legal Policies</Link>
            </p>
          </div>
        </div>
      </div>
